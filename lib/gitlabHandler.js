...
var detectEvent = function(payload, puppetfileRepo) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    if (!payload) {
      ...
      var repopath = payload.project.path_with_namespace;
      ...
      var eventInfo = { "pfrepo": puppetfileRepo, "pushuser": pushuser, "reponame": reponame, "branch": branch, "repourl": repourl, "repopath": repopath };
      ...
      if (refType !== 'heads') {
        ...
        if (created) {
          ...
          if (branch === defaultBranch) {
            return reject('Deletion of the golden "' + defaultBranch + '" branch is not allowed at the moment');
          }
          else {
